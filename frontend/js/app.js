...
const PAGINAS = {
  ...
  dashboard: {
    ...
    subtitulo: 'Bienvenido al sistema',
    html: null,
    fn: () => initDashboard()
  },

  acopio: {
    titulo: 'Acopio de Leche',
    subtitulo: 'Registro diario de entregas de leche por proveedor',
    html: 'acopio.html',
    fn: () => loadAcopio()
  },
  ...
  produccion: {
    titulo: 'Producción',
    subtitulo: 'Gestión y control de producción',
    html: 'produccion.html',
    fn: () => loadProduccion()
  },

  inventario: {
    titulo: 'Inventario',
    subtitulo: 'Control de productos y existencias',
  ...
  ventas: {
    titulo: 'Ventas',
    subtitulo: 'Registro y control de ventas',
    html: 'ventas.html',
    fn: () => loadVentas()
  },
  ...
  clientes: {
    titulo: 'Clientes',
    subtitulo: 'Gestión de clientes y compradores',
    html: 'clientes.html',
    fn: () => loadClientes()
  },
  ...
  proveedores: {
    titulo: 'Proveedores',
    subtitulo: 'Administración de proveedores',
    html: 'proveedores.html',
    fn: () => loadProveedores()
  },

  gastos: {
    titulo: 'Gastos',
    subtitulo: 'Control de gastos operativos',
    html: 'gastos.html',
    fn: () => loadGastos()
  },
